// E24_clnt.c: Sample application accessing the user-space driver 
// =============================================================
//
...
//
// *** Sample program for an applicatio for E2.4 programming assignment
//
// E. Glatz / 16-JAN-2009
...
int main ()
{
   ...
   printf("Waiting for reply of server\n");
   // Read text from pipe
